...
Strings are Immutable:
 1. Once we declare the string we cannot modify it, if we
 try to modify the string it will create new string.

 2. If new string does not have any reference variable then
 it will be removed.

 3. Python Internally uses String Intening.

 4. String Intening is the Process of Checking string Inten Pool
 before creating any new object.

5. Whenever we want to create new object, python first will check 
string inten pool, whether that object already exist or not.
